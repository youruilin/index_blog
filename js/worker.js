...
//         return {
//           apikey: "AIzaSyA46i-whVWCmD1mbvOOjfAilY706zc0WtI",
//           useBeta: false
//         };
//       }
//       const apikey = "AIzaSyA46i-whVWCmD1mbvOOjfAilY706zc0WtI"
...
// src/utils.ts
function getToken() {
  // 不再依赖请求头，只返回固定的 API 密钥
  const apikey = "AIzaSyCCkKtfzG8mhc6zYkL7MOPO5fjJDwc9dKY";
  return {
    apikey,
    useBeta: false // 如果你仍然需要使用 beta，可以根据需求设置
  };
}
...
var BASE_URL = "https://gemini-openai-proxy-new-git-main-youruilins-projects.vercel.app";
